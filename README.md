...
6. **Collision response** -- impulse-based rigid-body physics:
   ```
...
7. **Friction** -- Coulomb model applied tangentially at the contact point:
...
8. **Wall collisions** -- same impulse math, treating each screen edge as a
